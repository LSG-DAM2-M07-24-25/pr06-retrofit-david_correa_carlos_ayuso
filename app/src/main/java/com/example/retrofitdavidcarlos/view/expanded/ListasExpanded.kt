...
@Composable
fun ListasExpanded(navController: NavHostController, apiViewModel: ApiViewModel){
...
@Composable
fun ListasPreview(){
    ListasExpanded(navController = rememberNavController(), apiViewModel = ApiViewModel())
}