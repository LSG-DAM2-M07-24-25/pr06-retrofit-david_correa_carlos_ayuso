...
@Composable
fun CrearListaExpanded(navController: NavHostController, listViewModel: ListViewModel) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navController.navigate(Routes.ListasExpanded.route) }) {
                        Icon(
